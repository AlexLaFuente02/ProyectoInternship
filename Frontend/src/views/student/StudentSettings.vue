<template>
    ...
    <div class="view__settings__student">
        <h1 class="title"
        >Opciones</h1>
        <h6 class="description"
        >
            Aquí puedes cambiar tus datos como estudiante.
        </h6>
        <p>
            {{ dataUser }}
        </p>
        ...
        <div class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
				...
				<label for="tab1"><font-awesome-icon icon="user" size="2x" />
                    Usuario
                </label>
				...
				<ul>
					<li class="tab-content tab-content-first typography">
						<div class="information">
                            ...
                            <p>
                                Aquí puedes modificar tus datos de inicio de sesión.
                            </p>
                        </div>
                        <hr>
                        <div class="formulario">
                            <form action="">
                                <div class="entradaDisable">
                                    <label for="email">Email:</label>
                                    <input type="email" name="email" id="email" v-model="dataUser.correoelectronico" disabled>
                                </div>
                                <div class="entrada">
                                    <label for="password">Contraseña actual:</label>
                                    <input type="password" name="password" id="password" v-model="dataUser.contrasena">
                                </div>
                                <div class="entrada">
                                    <label for="password">Contraseña:</label>
                                    <InputPassword @input-emit="password"></InputPassword>
                                </div>
                                
                                <div class="entrada">
                                    <label for="password">Confirmar Contraseña:</label>
                                    <InputPassword @input-emit="confirmPassword"></InputPassword>
                                </div>
                                <div class="entradaButton">
                                    <Button 
                                        ...
                                        :color="0" 
                                        :disabled="false"
                                        @option-selected="updatePassword"
                                        >
                                    </Button>
					...
					<li class="tab-content tab-content-2 typography">
						<div class="information">
                            <h1>
                            Modificar {{ dataUser.graduado ? "Graduado" : "Estudiante" }}
                            </h1>
                            <p>
                                Aquí puedes modificar tus datos como {{ dataUser.graduado ? "Graduado" : "Estudiante" }}.
                            </p>
                        </div>
                        <hr>
                        <div class="formulario">
                            <form action="">
                                <div class="entrada">
                                    ...
                                    <input type="text" name="nombre" id="nombre" v-model="dataUser.nombres">
                                </div>
                                <div class="entrada">
                                ...
                                <div class="entrada">
                                    ...
                                    <input type="text" name="cedula" id="cedula" v-model="dataUser.carnetidentidad">
                                </div>
                                <div class="entrada">
                                    <label for="telefono">Teléfono:</label>
                                    <input type="text" name="telefono" id="telefono" v-model="dataUser.celularcontacto">
                                </div>
                                <div class="entrada">
                                ...
                                <div class="entrada" v-if="dataUser.graduado">
                                    ...
                                    <input type="text" name="semestre" id="semestre" v-model="dataUser.aniograduacion">
                                </div>
                                <div class="entradaButton">
                                    <Button 
...
.dark-theme .pcss3t .typography h1,
.dark-theme .pcss3t .typography h2,
.dark-theme .pcss3t .typography h3,
.dark-theme .pcss3t .typography h4,
.dark-theme .pcss3t .typography h5,
.dark-theme .pcss3t .typography h6 {
    color: #fff;
}
...
.dark-theme .pcss3t > label {
    background: #434B54;
}
.pcss3t > label:hover {
	background: #f2f2f2;
}
.dark-theme .pcss3t > label:hover {
    background: #434B54;
}
.pcss3t > input:checked + label {
	background: #fff;
}
.dark-theme .pcss3t > input:checked + label {
    background: #434B54;
}
.pcss3t > ul {
	background: #fff;
...
.dark-theme .pcss3t > ul {
    background: #434B54;
}
.pcss3t-steps > label:hover {
	background: #e5e5e5;	
}
.dark-theme .pcss3t-steps > label:hover {
    background: #434B54;
}

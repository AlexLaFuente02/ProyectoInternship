<template>
    <div class="inicio" v-if="allDataIsLoaded">
      <div >
        <div class="inicio2">
          <h1>
  ...
  import {useInstitutionsByIDSectorStore} from '@/store/student/institutionsByIDSectorStore';
    ...
    methods: {
      async getInstitutionData() {
        await useInstitutionsByIDSectorStore().loadInstitutionById(this.idInstitution);
        this.institutionInformation = useInstitutionsByIDSectorStore().institution;
    ...
    created() {
      this.idInstitution = this.$route.params.id;
    },

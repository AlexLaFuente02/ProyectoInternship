    ...
    <div class="formVue">
        ...
        <div class="container__select">
            <div class="select__container">
                <label>Area de pasantia *:</label>
                <Dropdown :options="this.listArea" :selectedValue="formStore.area" placeholderValue="Seleccione una sede" @option-selected="updateArea" class="dropdown-wide" />
            </div>
        </div>
        <div class="form__container">
            <div class="container__field">
                <div class="field__container">
                    <label>Funciones o actividades: *:</label>
                    <input placeholder="Introduzca su nombre" v-model="formStore.acti" type="text" class="field">
                </div>
            </div>
            <div class="container__field">
                <div class="field__container">
                    <label>Requisitos mínimos: *:</label>
                    <input placeholder="Introduzca su primer apellido" v-model="formStore.requi" type="text" class="field">
                </div>
            </div>
            <div class="field__container">
                <label cx>Horario:</label>
                <div class="checkbox-container">
                    <input type="radio" id="option1" v-model="formStore.selectedOption" value="option1">
                    <label for="option1">Tiempo completo</label>
                    <input type="radio" id="option2" v-model="formStore.selectedOption" value="option2">
            ...
            <div class="container__select">
                <div class="select__container">
                    ...
                    <Dropdown :options="this.listTiempo" :selectedValue="formStore.tiempo" placeholderValue="Seleccione una sede" @option-selected="updateTiempo" class="dropdown-wide" />
                </div>
            </div>

            <div class="container__field">
                <div class="field__container">
                    <label>Hasta que fecha la pasantia:</label>
